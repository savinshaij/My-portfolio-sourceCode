const Card5 = () => {
    return (
        <div
            ...
            className=" flex justify-center  items-center group relative h-[450px] w-[300px] lg:w-[400px] overflow-hidden"
        >

            <div className="w-80 h-[22rem] lg:w-full  rounded-3xl  bg-slate-200 "
            ...
            >
                <div className=" px-7 pt-12">
                    ...
                    <p className="text-sm  text-gray-400  md:text-base  font-normal  font-poppins ">
                        bbjghghjghg hjghjghjgh fghfgfgfghgh gfgfgh gfgf gfg f fgfghf gfgfgf gfgfg gfgfgggfgf ggfgfhhgt
                    </p>
