const Card1 = () => {
    return (
        ...
        >
            ...
            <div className="w-80 h-[22rem] lg:w-full  rounded-3xl  bg-cover bg-[url('/projectCardImages/1.jpg')] overflow-hidden   "
            ...
            >
                <div className=" px-7 pt-12">
                    ...
                    Redefining dining by seamlessly connecting food enthusiasts with diverse restaurants for an elevated culinary experience.
                    </p>
